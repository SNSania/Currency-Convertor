...
let apiLink = 
"https://v6.exchangerate-api.com/v6/ed939949d4fa6f972bc09503/latest/USD";
...
let conv = 
`https://v6.exchangerate-api.com/v6/ed939949d4fa6f972bc09503/pair/${firstCountry.name}/${secondCountry.name}`;
